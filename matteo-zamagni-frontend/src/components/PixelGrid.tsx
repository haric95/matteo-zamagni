...
export const PixelGrid: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <main className="fixed relative w-screen height-dynamic-screen flex justify-center items-center bg-white overflow-hidden">
      <div
      ...
      >
        {aboutPageData && (
          <Image
            ...
            className="bg-ledActive_Light dark:bg-ledActive_Dark opacity-40 dark:opacity-40 transition-all duration-1000 brightness-75"
      ...
      >
        <div
          ...
          style={{
            borderWidth:
              grid && grid[0][0]
                ? `${TARGET_CELL_SIZE / 2 - 1}px`
                : `${TARGET_CELL_SIZE / 2 - 0.5}px`,
